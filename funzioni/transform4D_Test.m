function imdsTest_mappe4D = transform4D_Test(imdsTest,dirname)

%Creo il dataset di train costituito dagli array 4D a partire
%dall'imdsTest
...
imdsTest_mappe4D=imageDatastore(digitDatasetPath, 'IncludeSubfolders',true,'ReadFcn', @b, 'LabelSource','foldernames',"FileExtensions",".mat");
