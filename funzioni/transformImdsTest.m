function imdsTest_mappe = transformImdsTest(imdsTest,dirname)
...
imdsTest_mappe=imageDatastore(digitDatasetPath, 'IncludeSubfolders',true,'ReadFcn', @read3, 'LabelSource','foldernames',"FileExtensions",".mat");
