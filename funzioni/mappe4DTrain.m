function imdsTrain = mappe4DTrain(imdsTrain,dirname)
...
imdsTrain=imageDatastore(digitDatasetPath, 'IncludeSubfolders',true,'ReadFcn', @b, 'LabelSource','foldernames',"FileExtensions",".mat");
