function [EEG_lap]=laplacian_EEG_Schalk(EEG)
...
for i=1:62
    ...
    if (num_neigh==4)
        EEG_lap(ele_princ,:)=4*EEG(ele_princ,:)-EEG(ele1,:)-EEG(ele2,:)-EEG(ele3,:)-EEG(ele4,:);
    elseif(num_neigh==3)
        EEG_lap(ele_princ,:)=3*EEG(ele_princ,:)-EEG(ele1,:)-EEG(ele2,:)-EEG(ele3,:);
    elseif(num_neigh==2)
        EEG_lap(ele_princ,:)=2*EEG(ele_princ,:)-EEG(ele1,:)-EEG(ele2,:);
    end
